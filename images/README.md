...
| `concept-visual.webp` | 「THE CONCEPT」セクションのビジュアル（見出し・コピー・3項目カードは画像内に配置済み） | 縦長 約1166:1349（そのまま全体表示） |
| `how-to-visual.webp` | 「使い方はシンプル。」セクションのビジュアル（見出し・STEP1〜3は画像内に配置済み） | 縦長 約1122:1402（そのまま全体表示） |
